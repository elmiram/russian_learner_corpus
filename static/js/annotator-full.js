  ...
  Annotator.Editor = (function(_super) {
    ...
    Editor.prototype.submit = function(event) {
      ...
      return this.hide();
              ...
              var items = [ "Graph", "Hyphen", "Space", "Ortho", "Translit", "Misspell", "Deriv", "Infl", "Num", "Gender", "Morph", "Asp", "ArgStr", "Passive", "Refl", "AgrNum", "AgrCase", "AgrGender", "AgrPers", "AgrGerund", "Gov", "Ref", "Conj", "WO", "Neg", "Aux", "Brev", "Syntax", "Constr", "Lex", "CS", "Par", "Idiom", "Transfer", "Not-clear", "Transp", "Subst", "Altern", "Tense", "Mode", "Prep", "GenNeg", "Disc","Extra", "Impers", "Miss" ];
